...
var _ = require('lodash'),
    ...
    skipFormIds = (process.env.SYNC !== 'false') ? ['_routes', '_content_types', '_assets'] : [];
    ...
    try {
        ...
        callback = function (operation, excludeFlag) {
            return function (err, data) {
                try {
                    ...
                    if (err) throw err;
                    if((operation === 'fetch' || operation === 'find') && !excludeFlag) removeUnpublishedAssets(data);
        ...
        switch (self._operation) {
            ...
            case 'find' :
                ...
                utility.queryBuilder(_query, self._locale, self.content_type_id, function (error, resultQuery) {
                    if (error) {
                        return callback(self._operation)(error);
                    }
                    _query = resultQuery;
                    if(_.has(_query, 'excludeUnpublishDeletion')) {
...
function removeUnpublishedAssets (data) {
